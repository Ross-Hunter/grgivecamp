...
<div class="feature_wrapper clearfix">
  <div class="feature tab1 container_12 clearfix">
    <div class="tabs clearfix">
      <div class="tab non-profit tab1 grid_12 clearfix">
        <div class="content">
          ...
          <div class="links grid_6">
            <a href="" class="button">Apply Now</a> or <a href="">find out how we can help</a>
          </div>
        </div>
      </div>
      ...
      <div class="tab sponsor tab4 grid_12 clearfix">
        <div class="content">
          ...
          <div class="links grid_6">
            <a href="" class="button">Become a sponsor</a> or <a href="">find out more about GiveCamp</a>
          </div>
        </div>    
      </div>    
    </div>
    <ul class="clearfix">
      ...
      <li class="grid_3 tab2"><a href="/2009/volunteer">Technical Volunteer</a></li>
      <li class="grid_3 tab3"><a href="/2009/helper">Non-Technical Volunteer</a></li>

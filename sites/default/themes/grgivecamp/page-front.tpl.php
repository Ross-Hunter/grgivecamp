    ...
    <div class="tabs clearfix">
      <div class="tab non-profit tab1 grid_12 clearfix">
        <div class="content">
          ...
          <div class="links grid_6">
            <a href="/non-profits" class="button">Apply Now</a> or <a href="/get-involved">find out how we can help</a>
          </div>
        </div>
      </div>
      ...
      <div class="tab sponsor tab4 grid_12 clearfix">
        <div class="content">
          ...
          <div class="links grid_6">
            <a href="/sponsors" class="button">Become a sponsor</a> or <a href="/get-involved">find out more about GiveCamp</a>
          </div>
        </div>
      </div>
    </div>
    <ul class="container_12">
      <li class="grid_3 tab1"><a href="/non-profits">Non-Profit</a></li>
